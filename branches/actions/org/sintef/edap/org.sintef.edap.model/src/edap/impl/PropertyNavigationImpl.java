...
public class PropertyNavigationImpl extends ExpressionImpl implements PropertyNavigation {
	...
	public Property getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdapPackage.PROPERTY_NAVIGATION__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(Property newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapPackage.PROPERTY_NAVIGATION__PROPERTY, oldProperty, property));
	}
