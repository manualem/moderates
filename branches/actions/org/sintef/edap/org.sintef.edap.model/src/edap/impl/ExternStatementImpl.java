 ...
 * <ul>
 *   <li>{@link edap.impl.ExternStatementImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternStatementImpl extends ActionImpl implements ExternStatement {
	...
	protected EClass eStaticClass() {
		return EdapPackage.Literals.EXTERN_STATEMENT;
	}
	...
	public void setStatement(String newStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapPackage.EXTERN_STATEMENT__STATEMENT, oldStatement, statement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdapPackage.EXTERN_STATEMENT__STATEMENT:
				return getStatement();
		}
