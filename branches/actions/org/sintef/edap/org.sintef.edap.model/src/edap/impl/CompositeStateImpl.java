 ...
 * <ul>
 *   <li>{@link edap.impl.CompositeStateImpl#getSubstate <em>Substate</em>}</li>
 *   <li>{@link edap.impl.CompositeStateImpl#getInitial <em>Initial</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeStateImpl extends StateImpl implements CompositeState {
	...
	protected EClass eStaticClass() {
		return EdapPackage.Literals.COMPOSITE_STATE;
	}
	...
	public EList<State> getSubstate() {
		if (substate == null) {
			substate = new EObjectContainmentEList<State>(State.class, this, EdapPackage.COMPOSITE_STATE__SUBSTATE);
		}
		return substate;
	}
		...
		if (initial != null && initial.eIsProxy()) {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdapPackage.COMPOSITE_STATE__INITIAL, oldInitial, initial));
			}
		}
		return initial;
	}
	...
	public void setInitial(State newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapPackage.COMPOSITE_STATE__INITIAL, oldInitial, initial));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdapPackage.COMPOSITE_STATE__SUBSTATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdapPackage.COMPOSITE_STATE__SUBSTATE:
				return getSubstate();
			case EdapPackage.COMPOSITE_STATE__INITIAL:
