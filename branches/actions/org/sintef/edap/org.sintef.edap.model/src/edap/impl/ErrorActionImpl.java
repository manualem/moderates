 ...
 * <ul>
 *   <li>{@link edap.impl.ErrorActionImpl#getMsg <em>Msg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ErrorActionImpl extends ActionImpl implements ErrorAction {
	...
	protected EClass eStaticClass() {
		return EdapPackage.Literals.ERROR_ACTION;
	}
	...
	public NotificationChain basicSetMsg(Expression newMsg, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdapPackage.ERROR_ACTION__MSG, oldMsg, newMsg);
	...
	public void setMsg(Expression newMsg) {
		if (newMsg != msg) {
			...
			if (msg != null)
				msgs = ((InternalEObject)msg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdapPackage.ERROR_ACTION__MSG, null, msgs);
			if (newMsg != null)
				msgs = ((InternalEObject)newMsg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdapPackage.ERROR_ACTION__MSG, null, msgs);
			msgs = basicSetMsg(newMsg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapPackage.ERROR_ACTION__MSG, newMsg, newMsg));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EdapPackage.ERROR_ACTION__MSG:
