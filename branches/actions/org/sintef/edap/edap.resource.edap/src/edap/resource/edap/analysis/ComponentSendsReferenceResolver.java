...
public class ComponentSendsReferenceResolver implements edap.resource.edap.IEdapReferenceResolver<edap.Component, edap.Message> {
	 ...
	 * @param id
	 */
	protected void checkSends (edap.Component owner, 
			String id, 
			boolean fuzzy,
			boolean isOwner,
			final edap.resource.edap.IEdapReferenceResolveResult<edap.Message> result) {
