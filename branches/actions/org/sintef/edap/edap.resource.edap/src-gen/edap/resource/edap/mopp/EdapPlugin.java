 ...
 */
public class EdapPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "edap.resource.edap";
	/**
	...
	private static EdapPlugin plugin;
	...
	public static EdapPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapPlugin.PLUGIN_ID, message);
		}
		final EdapPlugin pluginInstance = EdapPlugin.getDefault();
