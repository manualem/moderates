 ...
 * resolver
 */
public interface IEdapReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends edap.resource.edap.IEdapConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, edap.resource.edap.IEdapReferenceResolveResult<ReferenceType> result);
