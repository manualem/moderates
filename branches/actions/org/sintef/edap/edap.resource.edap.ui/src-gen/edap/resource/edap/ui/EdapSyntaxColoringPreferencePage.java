 ...
 */
public class EdapSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = edap.resource.edap.ui.EdapSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edap.resource.edap.ui.EdapSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		edap.resource.edap.ui.EdapPixelConverter pixelConverter = new edap.resource.edap.ui.EdapPixelConverter(composite);
	...
	public EdapSyntaxColoringPreferencePage() {
		super();
		
		edap.resource.edap.IEdapMetaInformation syntaxPlugin = new edap.resource.edap.mopp.EdapMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof edap.resource.edap.ui.EdapEditor) {
			edap.resource.edap.ui.EdapEditor emfTextEditor = (edap.resource.edap.ui.EdapEditor) editor;
