 ...
 */
public class EdapCompletionProposal implements java.lang.Comparable<EdapCompletionProposal> {
	...
	public EdapCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EdapCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EdapCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof EdapCompletionProposal) {
			EdapCompletionProposal other = (EdapCompletionProposal) object;
	...
	public int compareTo(EdapCompletionProposal object) {
		if (object instanceof EdapCompletionProposal) {
			EdapCompletionProposal other = (EdapCompletionProposal) object;
