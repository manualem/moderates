 ...
 */
public class EdapExpectedTerminal {
	
	private int followSetID;
	private edap.resource.edap.IEdapExpectedElement terminal;
	...
	public EdapExpectedTerminal(edap.resource.edap.IEdapExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public edap.resource.edap.IEdapExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((EdapExpectedTerminal) o).terminal);
	}
