 ...
 * olInput</code>.
 */
public class EdapDocBrowserInformationControlInput {
	
	private final EdapDocBrowserInformationControlInput fPrevious;
	private EdapDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EdapDocBrowserInformationControlInput(EdapDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EdapDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EdapDocBrowserInformationControlInput getNext() {
		return fNext;
	}
