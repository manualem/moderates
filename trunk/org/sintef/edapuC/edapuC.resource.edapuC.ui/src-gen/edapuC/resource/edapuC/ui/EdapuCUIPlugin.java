 ...
 */
public class EdapuCUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "edapuC.resource.edapuC.ui";
	...
	private static EdapuCUIPlugin plugin;
	
	public EdapuCUIPlugin() {
		super();
	}
	...
	public static EdapuCUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapuCUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapuCUIPlugin.PLUGIN_ID, message);
		}
		final EdapuCUIPlugin pluginInstance = EdapuCUIPlugin.getDefault();
