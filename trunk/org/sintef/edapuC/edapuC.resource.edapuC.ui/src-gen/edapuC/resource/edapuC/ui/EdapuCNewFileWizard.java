...
public class EdapuCNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private edapuC.resource.edapuC.ui.EdapuCNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public EdapuCNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new edapuC.resource.edapuC.ui.EdapuCNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new edapuC.resource.edapuC.mopp.EdapuCMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new edapuC.resource.edapuC.mopp.EdapuCMetaInformation().getSyntaxName();
	}
