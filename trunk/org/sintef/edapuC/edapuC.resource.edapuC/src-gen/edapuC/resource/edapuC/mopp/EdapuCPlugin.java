 ...
 */
public class EdapuCPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "edapuC.resource.edapuC";
	/**
	...
	private static EdapuCPlugin plugin;
	...
	public static EdapuCPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapuCPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdapuCPlugin.PLUGIN_ID, message);
		}
		final EdapuCPlugin pluginInstance = EdapuCPlugin.getDefault();
