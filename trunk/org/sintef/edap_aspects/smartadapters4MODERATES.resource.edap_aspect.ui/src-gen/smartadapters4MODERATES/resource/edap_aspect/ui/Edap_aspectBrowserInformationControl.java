 ...
 * @since 3.2
 */
public class Edap_aspectBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectDocBrowserInformationControlInput fInput;
	 ...
	 */
	public Edap_aspectBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Edap_aspectBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Edap_aspectBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectDocBrowserInformationControlInput);
		...
		fInput= (smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectDocBrowserInformationControlInput) input;
		...
		smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectDocBrowserInformationControlInput getInput() {
		return fInput;
	}
