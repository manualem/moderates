 ...
 * </ul>
 */
public class Edap_aspectBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectMetaInformation().getSyntaxName();
	
	private smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public Edap_aspectBracketPreferencePage() {
		super();
		
		smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectMetaInformation metaInformation = new smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) {
			((smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) editor).invalidateTextRepresentation();
		}
	}
