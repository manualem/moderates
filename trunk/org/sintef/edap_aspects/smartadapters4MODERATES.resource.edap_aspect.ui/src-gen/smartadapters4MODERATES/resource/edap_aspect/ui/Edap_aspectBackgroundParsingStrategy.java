 ...
 */
public class Edap_aspectBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectTextResource resource, final smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor) {
		if (resource == null) {
			return;
		}
