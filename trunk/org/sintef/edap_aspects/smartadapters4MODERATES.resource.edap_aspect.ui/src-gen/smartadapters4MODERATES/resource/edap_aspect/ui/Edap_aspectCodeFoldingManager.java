 ...
 */
public class Edap_aspectCodeFoldingManager {
	
	private class FoldingUpdateListener implements smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) {
				smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor = (smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) workbenchPart;
	...
	protected smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor;
	 ...
	 */
	public Edap_aspectCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor textEditor) {
	...
	private void addCloseListener(final smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectTextResource textResource = (smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
