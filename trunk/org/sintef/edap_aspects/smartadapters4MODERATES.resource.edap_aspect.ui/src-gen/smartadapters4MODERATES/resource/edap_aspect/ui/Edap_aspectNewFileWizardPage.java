 ...
 */
public class Edap_aspectNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public Edap_aspectNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new edap_aspect file");
