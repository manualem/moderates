 ...
 */
public class Edap_aspectSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPixelConverter pixelConverter = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPixelConverter(composite);
	...
	public Edap_aspectSyntaxColoringPreferencePage() {
		super();
		
		smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectMetaInformation syntaxPlugin = new smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) {
			smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor emfTextEditor = (smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) editor;
