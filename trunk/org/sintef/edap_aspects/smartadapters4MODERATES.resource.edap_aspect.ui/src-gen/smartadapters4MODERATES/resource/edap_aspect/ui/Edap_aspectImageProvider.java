 ...
 */
public class Edap_aspectImageProvider {
	
	public final static Edap_aspectImageProvider INSTANCE = new Edap_aspectImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectUIPlugin.getDefault().getBundle(), path, null));
