 ...
 * olInput</code>.
 */
public class Edap_aspectDocBrowserInformationControlInput {
	
	private final Edap_aspectDocBrowserInformationControlInput fPrevious;
	private Edap_aspectDocBrowserInformationControlInput fNext;
	 ...
	 */
	public Edap_aspectDocBrowserInformationControlInput(Edap_aspectDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public Edap_aspectDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public Edap_aspectDocBrowserInformationControlInput getNext() {
		return fNext;
	}
