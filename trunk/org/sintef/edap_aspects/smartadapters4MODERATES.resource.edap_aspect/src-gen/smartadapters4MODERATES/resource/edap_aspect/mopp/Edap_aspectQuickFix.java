...
public abstract class Edap_aspectQuickFix implements smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectQuickFix {
	...
	public Edap_aspectQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public Edap_aspectQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public Edap_aspectQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectPlugin.logError("Exception while applying quick fix", e);
		}
		return null;
	}
