 ...
 * resolver
 */
public interface IEdap_aspectReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectReferenceResolveResult<ReferenceType> result);
