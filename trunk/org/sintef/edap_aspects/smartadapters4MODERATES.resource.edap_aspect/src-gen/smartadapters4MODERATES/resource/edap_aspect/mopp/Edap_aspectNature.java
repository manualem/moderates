...
public class Edap_aspectNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "smartadapters4MODERATES.resource.edap_aspect.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
