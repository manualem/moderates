 ...
 * <ul>
 *   <li>{@link edap_relaxed.Connector#getOwner <em>Owner</em>}</li>
 *   <li>{@link edap_relaxed.Connector#getPort1 <em>Port1</em>}</li>
 *   <li>{@link edap_relaxed.Connector#getPort2 <em>Port2</em>}</li>
 *   <li>{@link edap_relaxed.Connector#getProp1 <em>Prop1</em>}</li>
 *   <li>{@link edap_relaxed.Connector#getProp2 <em>Prop2</em>}</li>
 * </ul>
 * </p>
 *
 * @see edap_relaxed.Edap_relaxedPackage#getConnector()
 * @model
 * @generated
 */
public interface Connector extends AnnotatedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link edap_relaxed.Component#getConnectors <em>Connectors</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see edap_relaxed.Edap_relaxedPackage#getConnector_Owner()
	...
	/**
	 * Sets the value of the '{@link edap_relaxed.Connector#getOwner <em>Owner</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPort1(Port)
	 * @see edap_relaxed.Edap_relaxedPackage#getConnector_Port1()
	 * @model required="true"
	 * @generated
	 */
	Port getPort1();
	...
	/**
	 * Sets the value of the '{@link edap_relaxed.Connector#getPort1 <em>Port1</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPort2(Port)
	 * @see edap_relaxed.Edap_relaxedPackage#getConnector_Port2()
	 * @model required="true"
	 * @generated
	 */
	Port getPort2();
	...
	/**
	 * Sets the value of the '{@link edap_relaxed.Connector#getPort2 <em>Port2</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edap_relaxed.Edap_relaxedPackage#getConnector_Prop1()
	 * @model
	 * @generated
	 */
	Property getProp1();
	...
	/**
	 * Sets the value of the '{@link edap_relaxed.Connector#getProp1 <em>Prop1</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edap_relaxed.Edap_relaxedPackage#getConnector_Prop2()
	 * @model
	 * @generated
	 */
	Property getProp2();
	...
	/**
	 * Sets the value of the '{@link edap_relaxed.Connector#getProp2 <em>Prop2</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
