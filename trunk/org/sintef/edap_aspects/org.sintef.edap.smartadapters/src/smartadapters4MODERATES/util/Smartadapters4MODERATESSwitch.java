 ...
 * @generated
 */
public class Smartadapters4MODERATESSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public Smartadapters4MODERATESSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Smartadapters4MODERATESPackage.CREATE_ADAPTATION: {
			...
			case Smartadapters4MODERATESPackage.SET_ADAPTATION: {
			...
			case Smartadapters4MODERATESPackage.UNSET_ADAPTATION: {
			...
			case Smartadapters4MODERATESPackage.GLOBAL_INSTANTIATION: {
			...
			case Smartadapters4MODERATESPackage.SCOPED_INSTANTIATION: {
			...
			case Smartadapters4MODERATESPackage.PER_ROLE_MATCH: {
			...
			case Smartadapters4MODERATESPackage.PER_ELEMENT_MATCH: {
