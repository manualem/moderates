 ...
 * <ul>
 *   <li>{@link smartadapters4MODERATES.impl.ScopedInstantiationImpl#getPointcutElements <em>Pointcut Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ScopedInstantiationImpl extends InstantiationStrategyImpl implements ScopedInstantiation {
	...
	protected EClass eStaticClass() {
		return Smartadapters4MODERATESPackage.Literals.SCOPED_INSTANTIATION;
	}
	...
	public EList<AspectModelElement> getPointcutElements() {
		if (pointcutElements == null) {
			pointcutElements = new EObjectResolvingEList<AspectModelElement>(AspectModelElement.class, this, Smartadapters4MODERATESPackage.SCOPED_INSTANTIATION__POINTCUT_ELEMENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Smartadapters4MODERATESPackage.SCOPED_INSTANTIATION__POINTCUT_ELEMENTS:
