 ...
 * <ul>
 *   <li>{@link smartadapters4MODERATES.impl.InstantiationStrategyImpl#getAdviceElements <em>Advice Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InstantiationStrategyImpl extends EObjectImpl implements InstantiationStrategy {
	...
	protected EClass eStaticClass() {
		return Smartadapters4MODERATESPackage.Literals.INSTANTIATION_STRATEGY;
	}
	...
	public EList<AspectModelElement> getAdviceElements() {
		if (adviceElements == null) {
			adviceElements = new EObjectResolvingEList<AspectModelElement>(AspectModelElement.class, this, Smartadapters4MODERATESPackage.INSTANTIATION_STRATEGY__ADVICE_ELEMENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Smartadapters4MODERATESPackage.INSTANTIATION_STRATEGY__ADVICE_ELEMENTS:
