 ...
 * <ul>
 *   <li>{@link smartadapters4MODERATES.impl.PointcutModelImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutModelImpl extends EObjectImpl implements PointcutModel {
	...
	protected EClass eStaticClass() {
		return Smartadapters4MODERATESPackage.Literals.POINTCUT_MODEL;
	}
	...
	public EList<AspectModelElement> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<AspectModelElement>(AspectModelElement.class, this, Smartadapters4MODERATESPackage.POINTCUT_MODEL__CONTENT);
		}
		return content;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Smartadapters4MODERATESPackage.POINTCUT_MODEL__CONTENT:
