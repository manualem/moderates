 ...
 */
public class EdapuCMinimalModelHelper {
	
	private final static edapuC.resource.edapuC.util.EdapuCEClassUtil eClassUtil = new edapuC.resource.edapuC.util.EdapuCEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + edapuC.resource.edapuC.util.EdapuCStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = edapuC.resource.edapuC.util.EdapuCListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + edapuC.resource.edapuC.util.EdapuCStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = edapuC.resource.edapuC.util.EdapuCListUtil.castListUnchecked(value);
