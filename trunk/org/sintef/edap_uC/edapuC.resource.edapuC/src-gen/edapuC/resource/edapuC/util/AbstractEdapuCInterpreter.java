 ...
 */
public class AbstractEdapuCInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof edapuC.UCApplication) {
			result = interprete_edapuC_UCApplication((edapuC.UCApplication) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.UCElement) {
			result = interprete_edapuC_UCElement((edapuC.UCElement) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.StaticProperty) {
			result = interprete_edapuC_StaticProperty((edapuC.StaticProperty) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.Template) {
			result = interprete_edapuC_Template((edapuC.Template) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.UCMessage) {
			result = interprete_edapuC_UCMessage((edapuC.UCMessage) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.UCDevice) {
			result = interprete_edapuC_UCDevice((edapuC.UCDevice) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof edapuC.UCGenerator) {
			result = interprete_edapuC_UCGenerator((edapuC.UCGenerator) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_edapuC_UCGenerator(edapuC.UCGenerator object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_UCDevice(edapuC.UCDevice object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_UCMessage(edapuC.UCMessage object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_Template(edapuC.Template object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_StaticProperty(edapuC.StaticProperty object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_UCElement(edapuC.UCElement object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_edapuC_UCApplication(edapuC.UCApplication object, ContextType context) {
		return null;
	}
