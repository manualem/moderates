...
public class EdapuCNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "edapuC.resource.edapuC.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {edapuC.resource.edapuC.mopp.EdapuCBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(edapuC.resource.edapuC.mopp.EdapuCBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
