...
public class EdapuCGENERATORTokenResolver implements edapuC.resource.edapuC.IEdapuCTokenResolver {
	...
	public void resolve(java.lang.String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, edapuC.resource.edapuC.IEdapuCTokenResolveResult result) {
		result.setResolvedToken(lexem.substring(11, lexem.length()-12));
	}
