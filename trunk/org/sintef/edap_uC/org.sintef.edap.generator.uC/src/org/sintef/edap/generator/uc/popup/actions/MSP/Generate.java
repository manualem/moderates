...
public class Generate implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		console.println(new InfoMessage("Launching EDAP MSP Generator on file : " + file.getLocation().toOSString() + "..."));
		...
		try {			
			...
			String kmt = "platform:/resource" + file.getParent().getFullPath().toString() + "/msp_templates/Generator.kmt";
			...
			KExecMain.run(kmt, "edapuC::Main", "generateDevices", file_uri, path, console);
