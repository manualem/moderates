 ...
 ******************************************************************************/
package org.sintef.edap.generator.uc.popup.actions;
...
public class Text2XMI implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		console.println(new InfoMessage("Launching EDAP 2 XMI : " + file.getLocation().toOSString() + "..."));
