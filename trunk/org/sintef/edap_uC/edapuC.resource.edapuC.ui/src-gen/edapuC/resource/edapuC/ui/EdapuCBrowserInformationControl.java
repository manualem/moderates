 ...
 * @since 3.2
 */
public class EdapuCBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private edapuC.resource.edapuC.ui.EdapuCDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EdapuCBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EdapuCBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EdapuCBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof edapuC.resource.edapuC.ui.EdapuCDocBrowserInformationControlInput);
		...
		fInput= (edapuC.resource.edapuC.ui.EdapuCDocBrowserInformationControlInput) input;
		...
		edapuC.resource.edapuC.ui.EdapuCHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = edapuC.resource.edapuC.ui.EdapuCHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public edapuC.resource.edapuC.ui.EdapuCDocBrowserInformationControlInput getInput() {
		return fInput;
	}
