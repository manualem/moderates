 ...
 */
public class EdapuCSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edapuC.resource.edapuC.ui.EdapuCSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		edapuC.resource.edapuC.ui.EdapuCPixelConverter pixelConverter = new edapuC.resource.edapuC.ui.EdapuCPixelConverter(composite);
	...
	public EdapuCSyntaxColoringPreferencePage() {
		super();
		
		edapuC.resource.edapuC.IEdapuCMetaInformation syntaxPlugin = new edapuC.resource.edapuC.mopp.EdapuCMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof edapuC.resource.edapuC.ui.EdapuCEditor) {
			edapuC.resource.edapuC.ui.EdapuCEditor emfTextEditor = (edapuC.resource.edapuC.ui.EdapuCEditor) editor;
