 ...
 */
public class EdapuCHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EdapuCHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof edapuC.resource.edapuC.ui.EdapuCEditor) {
					edapuC.resource.edapuC.ui.EdapuCEditor emftEditor = (edapuC.resource.edapuC.ui.EdapuCEditor) editorPart;
