 ...
 */
public class EdapuCImageProvider {
	
	public final static EdapuCImageProvider INSTANCE = new EdapuCImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor desriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(edapuC.resource.edapuC.ui.EdapuCUIPlugin.getDefault().getBundle(), path, null));
