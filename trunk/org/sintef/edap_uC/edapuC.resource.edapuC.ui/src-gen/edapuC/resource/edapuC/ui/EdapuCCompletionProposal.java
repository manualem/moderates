 ...
 */
public class EdapuCCompletionProposal implements java.lang.Comparable<EdapuCCompletionProposal> {
	...
	public EdapuCCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EdapuCCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EdapuCCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof EdapuCCompletionProposal) {
			EdapuCCompletionProposal other = (EdapuCCompletionProposal) object;
	...
	public int compareTo(EdapuCCompletionProposal object) {
		if (object instanceof EdapuCCompletionProposal) {
			EdapuCCompletionProposal other = (EdapuCCompletionProposal) object;
