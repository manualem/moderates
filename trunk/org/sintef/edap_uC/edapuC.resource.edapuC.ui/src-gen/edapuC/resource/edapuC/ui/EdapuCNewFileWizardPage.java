 ...
 */
public class EdapuCNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EdapuCNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new edapuC file");
