...
#define MRFI_CC2500_SPI_REG_FREQEST      0x32      /*  FREQEST    Ã?Â?Ã?Â± Frequency Offset Estimate from demodulator */
#define MRFI_CC2500_SPI_REG_LQI          0x33      /*  LQI        Ã?Â?Ã?Â± Demodulator estimate for Link Quality */
#define MRFI_CC2500_SPI_REG_RSSI         0x34      /*  RSSI       Ã?Â?Ã?Â± Received signal strength indication */
#define MRFI_CC2500_SPI_REG_MARCSTATE    0x35      /*  MARCSTATE  Ã?Â?Ã?Â± Main Radio Control State Machine state */
#define MRFI_CC2500_SPI_REG_WORTIME1     0x36      /*  WORTIME1   Ã?Â?Ã?Â± High byte of WOR time */
#define MRFI_CC2500_SPI_REG_WORTIME0     0x37      /*  WORTIME0   Ã?Â?Ã?Â± Low byte of WOR time */
#define MRFI_CC2500_SPI_REG_PKTSTATUS    0x38      /*  PKTSTATUS  Ã?Â?Ã?Â± Current GDOx status and packet status */
#define MRFI_CC2500_SPI_REG_VCO_VC_DAC   0x39      /*  VCO_VC_DAC Ã?Â?Ã?Â± Current setting from PLL calibration module */
#define MRFI_CC2500_SPI_REG_TXBYTES      0x3A      /*  TXBYTES    Ã?Â?Ã?Â± Underflow and number of bytes */
#define MRFI_CC2500_SPI_REG_RXBYTES      0x3B      /*  RXBYTES    Ã?Â?Ã?Â± Overflow and number of bytes */
...
// Implemetation of void RF2500_send_power_on()

	hal_spi_radio_cmdStrobe( MRFI_CC2500_SPI_STROBE_SRX );

}
void RF2500_send_power_off() {
// Implemetation of void RF2500_send_power_off()
