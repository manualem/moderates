 ...
 */
public class Edap_aspectHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionHelper positionHelper = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionHelper();
	private boolean isHighlightBrackets = true;
	private smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectTokenScanner scanner;
	...
	private smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectOccurrence occurrence;
	private smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public Edap_aspectHighlighting(smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectColorManager colorManager, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectUIPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectTokenScanner(textResource, colorManager);
		occurrence = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectTextResource) {
