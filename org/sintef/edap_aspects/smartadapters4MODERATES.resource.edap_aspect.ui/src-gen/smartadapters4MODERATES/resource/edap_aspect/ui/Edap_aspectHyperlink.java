 ...
 */
public class Edap_aspectHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public Edap_aspectHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) {
					smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor emftEditor = (smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor) editorPart;
