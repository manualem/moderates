 ...
 */
public class Edap_aspectBracketSet {
	...
	private java.util.ArrayList<smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair {
	 ...
	 */
	private class ClosingListener implements smartadapters4MODERATES.resource.edap_aspect.ui.IEdap_aspectBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public Edap_aspectBracketSet(smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair>();
	 ...
	 */
	public smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair getBracketPair(String opening, String closing) {
		for (smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair : bracketPairs) {
	...
	public smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair remove(String opening, String closing) {
		for (smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<smartadapters4MODERATES.resource.edap_aspect.IEdap_aspectBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, smartadapters4MODERATES.resource.edap_aspect.ui.Edap_aspectPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
