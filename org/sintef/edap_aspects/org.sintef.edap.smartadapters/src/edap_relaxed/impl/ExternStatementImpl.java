 ...
 * <ul>
 *   <li>{@link edap_relaxed.impl.ExternStatementImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternStatementImpl extends ActionImpl implements ExternStatement {
	...
	protected EClass eStaticClass() {
		return Edap_relaxedPackage.Literals.EXTERN_STATEMENT;
	}
	...
	public void setStatement(String newStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Edap_relaxedPackage.EXTERN_STATEMENT__STATEMENT, oldStatement, statement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Edap_relaxedPackage.EXTERN_STATEMENT__STATEMENT:
				return getStatement();
		}
