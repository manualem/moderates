 ...
 * <ul>
 *   <li>{@link edap_relaxed.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends TypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return Edap_relaxedPackage.Literals.ENUMERATION;
	}
	...
	public EList<EnumerationLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, Edap_relaxedPackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Edap_relaxedPackage.ENUMERATION__LITERALS:
