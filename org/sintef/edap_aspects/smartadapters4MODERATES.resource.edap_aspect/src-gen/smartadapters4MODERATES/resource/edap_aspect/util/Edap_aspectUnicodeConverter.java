 ...
 * to 4 bytes).
 */
public class Edap_aspectUnicodeConverter extends smartadapters4MODERATES.resource.edap_aspect.mopp.Edap_aspectInputStreamProcessor {
	 ...
	 */
	public Edap_aspectUnicodeConverter(java.io.InputStream inputStream) {
