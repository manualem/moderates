 ...
 * <ul>
 *   <li>{@link edapuC.impl.TemplateImpl#getText <em>Text</em>}</li>
 *   <li>{@link edapuC.impl.TemplateImpl#getGenerator <em>Generator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateImpl extends EObjectImpl implements Template {
	...
	protected EClass eStaticClass() {
		return EdapuCPackage.Literals.TEMPLATE;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapuCPackage.TEMPLATE__TEXT, oldText, text));
	}
	...
	public void setGenerator(String newGenerator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapuCPackage.TEMPLATE__GENERATOR, oldGenerator, generator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdapuCPackage.TEMPLATE__TEXT:
				return getText();
			case EdapuCPackage.TEMPLATE__GENERATOR:
				return getGenerator();
		}
