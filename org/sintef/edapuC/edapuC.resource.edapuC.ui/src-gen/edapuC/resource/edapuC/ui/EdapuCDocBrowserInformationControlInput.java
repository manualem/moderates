 ...
 * olInput</code>.
 */
public class EdapuCDocBrowserInformationControlInput {
	
	private final EdapuCDocBrowserInformationControlInput fPrevious;
	private EdapuCDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EdapuCDocBrowserInformationControlInput(EdapuCDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EdapuCDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EdapuCDocBrowserInformationControlInput getNext() {
		return fNext;
	}
