 ...
 * to 4 bytes).
 */
public class EdapuCUnicodeConverter extends edapuC.resource.edapuC.mopp.EdapuCInputStreamProcessor {
	 ...
	 */
	public EdapuCUnicodeConverter(java.io.InputStream inputStream) {
