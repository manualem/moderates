...
public class EdapuCBracketSet {
	...
	private java.util.ArrayList<edapuC.resource.edapuC.IEdapuCBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements edapuC.resource.edapuC.IEdapuCBracketPair {
	 ...
	 */
	private class ClosingListener implements edapuC.resource.edapuC.ui.IEdapuCBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				edapuC.resource.edapuC.IEdapuCBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public EdapuCBracketSet(edapuC.resource.edapuC.ui.EdapuCEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new edapuC.resource.edapuC.mopp.EdapuCMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<edapuC.resource.edapuC.IEdapuCBracketPair>();
	 ...
	 */
	public edapuC.resource.edapuC.IEdapuCBracketPair getBracketPair(String opening, String closing) {
		for (edapuC.resource.edapuC.IEdapuCBracketPair bracketPair : bracketPairs) {
	...
	public edapuC.resource.edapuC.IEdapuCBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(edapuC.resource.edapuC.IEdapuCBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + edapuC.resource.edapuC.ui.EdapuCPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public edapuC.resource.edapuC.IEdapuCBracketPair remove(String opening, String closing) {
		for (edapuC.resource.edapuC.IEdapuCBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<edapuC.resource.edapuC.IEdapuCBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, edapuC.resource.edapuC.ui.EdapuCPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, edapuC.resource.edapuC.ui.EdapuCPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
