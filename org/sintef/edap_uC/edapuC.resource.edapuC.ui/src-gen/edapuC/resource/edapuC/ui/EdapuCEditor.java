...
/**
 * A text editor for 'edapuC' models.
 */
public class EdapuCEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private edapuC.resource.edapuC.ui.EdapuCHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private edapuC.resource.edapuC.ui.EdapuCCodeFoldingManager codeFoldingManager;
	private edapuC.resource.edapuC.ui.EdapuCBackgroundParsingStrategy bgParsingStrategy = new edapuC.resource.edapuC.ui.EdapuCBackgroundParsingStrategy();
	private java.util.Collection<edapuC.resource.edapuC.IEdapuCBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<edapuC.resource.edapuC.IEdapuCBackgroundParsingListener>();
	private edapuC.resource.edapuC.ui.EdapuCColorManager colorManager = new edapuC.resource.edapuC.ui.EdapuCColorManager();
	private edapuC.resource.edapuC.ui.EdapuCOutlinePage outlinePage;
	...
	private edapuC.resource.edapuC.ui.EdapuCPropertySheetPage propertySheetPage;
	...
	private edapuC.resource.edapuC.ui.IEdapuCBracketHandler bracketHandler;
	
	public EdapuCEditor() {
		super();
		setSourceViewerConfiguration(new edapuC.resource.edapuC.ui.EdapuCEditorConfiguration(this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), EdapuCEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								edapuC.resource.edapuC.IEdapuCTextResource currentResource = getResource();
				...
				edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("edapuC.resource.edapuC.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new edapuC.resource.edapuC.ui.EdapuCHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new edapuC.resource.edapuC.ui.EdapuCCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		edapuC.resource.edapuC.mopp.EdapuCNature.activate(inputFile.getProject());
		...
		edapuC.resource.edapuC.IEdapuCTextResource loadedResource = (edapuC.resource.edapuC.IEdapuCTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				edapuC.resource.edapuC.IEdapuCTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof edapuC.resource.edapuC.IEdapuCTextResource) {
					setResource((edapuC.resource.edapuC.IEdapuCTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					edapuC.resource.edapuC.ui.EdapuCUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the EdapuCEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(edapuC.resource.edapuC.IEdapuCTextResource resource) {
		assert resource != null;
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new edapuC.resource.edapuC.ui.EdapuCOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new edapuC.resource.edapuC.ui.EdapuCPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			edapuC.resource.edapuC.IEdapuCTextResource textResource = (edapuC.resource.edapuC.IEdapuCTextResource) element.eResource();
			...
			edapuC.resource.edapuC.IEdapuCTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				edapuC.resource.edapuC.IEdapuCTextToken token = lexer.getNextToken();
			...
			edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(edapuC.resource.edapuC.IEdapuCBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (edapuC.resource.edapuC.IEdapuCBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public edapuC.resource.edapuC.ui.IEdapuCBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(edapuC.resource.edapuC.ui.IEdapuCBracketHandler bracketHandler) {
