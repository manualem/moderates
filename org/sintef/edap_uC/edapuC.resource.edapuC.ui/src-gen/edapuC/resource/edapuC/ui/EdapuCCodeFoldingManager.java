 ...
 */
public class EdapuCCodeFoldingManager {
	
	private class FoldingUpdateListener implements edapuC.resource.edapuC.IEdapuCBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(edapuC.resource.edapuC.ui.EdapuCEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof edapuC.resource.edapuC.ui.EdapuCEditor) {
				edapuC.resource.edapuC.ui.EdapuCEditor editor = (edapuC.resource.edapuC.ui.EdapuCEditor) workbenchPart;
	...
	protected edapuC.resource.edapuC.ui.EdapuCEditor editor;
	 ...
	 */
	public EdapuCCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,edapuC.resource.edapuC.ui.EdapuCEditor textEditor) {
	...
	private void addCloseListener(final edapuC.resource.edapuC.ui.EdapuCEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			edapuC.resource.edapuC.ui.EdapuCUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		edapuC.resource.edapuC.IEdapuCTextResource textResource = (edapuC.resource.edapuC.IEdapuCTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
