...
public class GenerateJava implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		console.println(new InfoMessage("Launching ThingML Java Protocol Generator on : " + file.getLocation().toOSString() + "..."));
		...
		try {			
			...
			String kmt = "platform:/plugin/org.sintef.thingML.protocol.generator/kermeta/main.kmt";
			...
			KExecMain.run(kmt, "thingML::MainJavaProtocolGenerator", "main", file_uri, path, console);
