...
public class EdapTextToken implements edap.resource.edap.IEdapTextToken {
	
	private final edap.resource.edap.IEdapMetaInformation metaInformation = new edap.resource.edap.mopp.EdapMetaInformation();
	private final org.antlr.runtime3_2_0.Token antlrToken;
	
	public EdapTextToken(org.antlr.runtime3_2_0.Token antlrToken) {
		super();
