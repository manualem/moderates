...
public abstract class EdapANTLRParserBase extends org.antlr.runtime3_2_0.Parser implements edap.resource.edap.IEdapTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<edap.resource.edap.IEdapCommand<edap.resource.edap.IEdapTextResource>> postParseCommands;
	...
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, edap.resource.edap.grammar.EdapSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		if (element == null) {
			return;
		}
		...
		isElementToStore |= syntaxElement instanceof edap.resource.edap.grammar.EdapPlaceholder;
		isElementToStore |= syntaxElement instanceof edap.resource.edap.grammar.EdapKeyword;
		isElementToStore |= syntaxElement instanceof edap.resource.edap.grammar.EdapEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof edap.resource.edap.grammar.EdapBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		for (org.antlr.runtime3_2_0.CommonToken anonymousToken : anonymousTokens) {
			layoutInformationAdapter.addLayoutInformation(new edap.resource.edap.mopp.EdapLayoutInformation(syntaxElement, object, anonymousToken.getStartIndex(), anonymousToken.getText(), null));
		}
