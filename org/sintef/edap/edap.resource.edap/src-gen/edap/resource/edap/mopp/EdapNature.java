...
public class EdapNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "edap.resource.edap.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {edap.resource.edap.mopp.EdapBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(edap.resource.edap.mopp.EdapBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
