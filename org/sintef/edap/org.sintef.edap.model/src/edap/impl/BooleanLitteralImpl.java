 ...
 * <ul>
 *   <li>{@link edap.impl.BooleanLitteralImpl#isBoolValue <em>Bool Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLitteralImpl extends LitteralImpl implements BooleanLitteral {
	...
	protected EClass eStaticClass() {
		return EdapPackage.Literals.BOOLEAN_LITTERAL;
	}
	...
	public void setBoolValue(boolean newBoolValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdapPackage.BOOLEAN_LITTERAL__BOOL_VALUE, oldBoolValue, boolValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdapPackage.BOOLEAN_LITTERAL__BOOL_VALUE:
				return isBoolValue();
		}
