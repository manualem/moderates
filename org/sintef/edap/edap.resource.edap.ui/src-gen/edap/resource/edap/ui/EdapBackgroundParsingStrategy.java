 ...
 */
public class EdapBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final edap.resource.edap.IEdapTextResource resource, final edap.resource.edap.ui.EdapEditor editor) {
		if (resource == null) {
			return;
		}
