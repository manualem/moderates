 ...
 */
public class EdapHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EdapHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof edap.resource.edap.ui.EdapEditor) {
					edap.resource.edap.ui.EdapEditor emftEditor = (edap.resource.edap.ui.EdapEditor) editorPart;
