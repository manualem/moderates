 ...
 * a specified depth.
 */
public class EdapOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public EdapOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof edap.resource.edap.ui.EdapEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			edap.resource.edap.mopp.EdapPlugin.logError("Exception while refreshing outline view", e);
		}
	}
