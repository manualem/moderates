 ...
 */
public class EdapCodeFoldingManager {
	
	private class FoldingUpdateListener implements edap.resource.edap.IEdapBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(edap.resource.edap.ui.EdapEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof edap.resource.edap.ui.EdapEditor) {
				edap.resource.edap.ui.EdapEditor editor = (edap.resource.edap.ui.EdapEditor) workbenchPart;
	...
	protected edap.resource.edap.ui.EdapEditor editor;
	 ...
	 */
	public EdapCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,edap.resource.edap.ui.EdapEditor textEditor) {
	...
	private void addCloseListener(final edap.resource.edap.ui.EdapEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			edap.resource.edap.ui.EdapUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		edap.resource.edap.IEdapTextResource textResource = (edap.resource.edap.IEdapTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
