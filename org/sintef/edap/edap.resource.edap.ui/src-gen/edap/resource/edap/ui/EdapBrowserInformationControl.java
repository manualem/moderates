 ...
 * @since 3.2
 */
public class EdapBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private edap.resource.edap.ui.EdapDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EdapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EdapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EdapBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof edap.resource.edap.ui.EdapDocBrowserInformationControlInput);
		...
		fInput= (edap.resource.edap.ui.EdapDocBrowserInformationControlInput) input;
		...
		edap.resource.edap.ui.EdapHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = edap.resource.edap.ui.EdapHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public edap.resource.edap.ui.EdapDocBrowserInformationControlInput getInput() {
		return fInput;
	}
