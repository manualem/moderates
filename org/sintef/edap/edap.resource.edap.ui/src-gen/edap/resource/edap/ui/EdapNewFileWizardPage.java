 ...
 */
public class EdapNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EdapNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new edap file");
